    ...
    private static func defaultTools(workspacePath: String) -> [CockpitToolDescriptor] {
        ...
        return [
            ...
            CockpitToolDescriptor(
                ...
                mission: "Controle qualite documentaire deterministe V1 (lecture seule), avec seed analyse/metadata/preclassement.",
                repositoryPath: repo("MuniControle"),
                executable: "muni-controle-cli",
                executablePath: nil,
                version: "0.2.0",
                integrationStatus: "active",
                capabilities: ["run", "audit", "canonical-run", "quality-control-v1", "analysis-seed-v1", "metadata-seed-v1", "preclassification-seed-v1", "read-only"],
                defaultAction: "audit",
                defaultParameters: [
                    "text": .string("Compte rendu municipal a controler pour validation qualite documentaire."),
