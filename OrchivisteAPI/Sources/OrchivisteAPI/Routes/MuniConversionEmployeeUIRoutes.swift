...
func registerMuniConversionEmployeeUIRoutes(_ app: Application) {
    let buildContext: @Sendable (Request) async throws -> UIMuniConversionEmployeeContext = { req in
        ...
        return UIMuniConversionEmployeeContext(
            ...
            result_profile_id: resultSnapshot?.metadata.profileID.map(muniConversionProfileLabel) ?? "-",
...
private func muniConversionProfileOptions(selectedID: String) -> [UIMuniConversionProfileOption] {
    [
        ("doc_to_docx", "Word - DOC -> DOCX"),
        ("doc_to_pdf", "Word - DOC -> PDF"),
        ("docx_to_pdf", "Word - DOCX -> PDF"),
        ("docx_to_doc", "Word - DOCX -> DOC"),
        ("xls_to_xlsx", "Excel - XLS -> XLSX"),
        ("xls_to_pdf", "Excel - XLS -> PDF"),
        ("xlsx_to_pdf", "Excel - XLSX -> PDF"),
        ("xlsx_to_xls", "Excel - XLSX -> XLS"),
        ("ppt_to_pptx", "PowerPoint - PPT -> PPTX"),
        ("ppt_to_pdf", "PowerPoint - PPT -> PDF"),
        ("pptx_to_pdf", "PowerPoint - PPTX -> PDF"),
        ("pptx_to_ppt", "PowerPoint - PPTX -> PPT"),
        ("rtf_to_docx", "Texte - RTF -> DOCX"),
        ("rtf_to_pdf", "Texte - RTF -> PDF"),
        ("txt_to_pdf", "Texte - TXT -> PDF"),
        ("odt_to_pdf", "OpenDocument - ODT -> PDF"),
        ("ods_to_pdf", "OpenDocument - ODS -> PDF"),
        ("odp_to_pdf", "OpenDocument - ODP -> PDF")
    ].map { id, label in
